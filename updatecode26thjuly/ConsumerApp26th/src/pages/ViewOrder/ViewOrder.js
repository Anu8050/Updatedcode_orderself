...
function ViewOrder() {
  ...
  const [isTipValueExceeded, setIsTipValueExceeded] = React.useState(false);              
  ...
  const handleFoodNameClick = (index) => {
     const updatedMyData = [...myData];
     updatedMyData[index].expanded = !updatedMyData[index].expanded;
                          ...
                          if (item.foodPrice) {
                            ...
                            return (
                              <tbody key={{ generatedUUID }}>
                                ...
                                whiteSpace: item.expanded ? "pre-wrap" : "nowrap",
                                overflow: "hidden",
                                textOverflow: item.expanded ? "initial" : "ellipsis",
                                cursor: "pointer",
                                wordBreak: "break-word",
                                }}
                                title={item.foodName}
                                  onClick={() => handleFoodNameClick(index)}
                                >
                                {item.expanded ? item.foodName : `${item.foodName.substring(0, 10)}...`}
                                </span>
                                ) : (
                                item.foodName
                                )}
                  ...
                  >
                    <TextField
                      ...
                      sx={{ 
                       ...
                       error={isTipValueExceeded}
                       helperText={isTipValueExceeded ?"Tip amount should not exceed 50" : ""} 
                       disabled={showTipValue}
                    />
                    <Button
                      type="submit"
                      disableElevation
                      ...
                      disabled={isTipValueExceeded || showTipValue}
                      endIcon={<AddBoxIcon/>}
                    >
                      Add Tip
                    </Button>
