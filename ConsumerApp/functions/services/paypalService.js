...
const sellerOnBoardStatus = async (data) => {
  console.log(
    "🚀 ~ file: paypalService.js:172 ~ sellerOnBoardStatus ~ data:",
    data
  );
  const PAYPAL_PARTNER_ATTRIBUTION_ID =
    paypalConfig.paypal_partner_attribution_id;
  ...
  console.log(
    "🚀 ~ file: paypalService.js:178 ~ sellerOnBoardStatus ~ sellerMerchantId:",
    sellerMerchantId
  );
  const trackingId = data.trackingId;
  console.log(
    "🚀 ~ file: paypalService.js:180 ~ sellerOnBoardStatus ~ trackingId:",
    trackingId
  );
  ...
  try {
    ...
    if (response.ok) {
      ...
      confirmSellerVerification(sellerData, trackingId, sellerMerchantId);
      return sellerData;
    } else {
